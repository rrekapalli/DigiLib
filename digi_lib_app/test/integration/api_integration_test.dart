...
void main() {
  group('API Integration Tests', () {
    ...
    late DocumentApiService documentService;
    late LibraryApiService libraryService;

    setUp(() {
      mockApiClient = MockApiClient();
      authService = AuthApiService(apiClient: mockApiClient);
      documentService = DocumentApiService(apiClient: mockApiClient);
      libraryService = LibraryApiService(apiClient: mockApiClient);
    });
    ...
    group('Authentication API', () {
      ...
      test('should get current user successfully', () async {
        ...
        verify(mockApiClient.get<Map<String, dynamic>>('/api/users/me')).called(1);
      });
      ...
      test('should handle authentication errors', () async {
        ...
        expect(
          () => authService.signInWithOAuth2('google', 'invalid_code', 'state', 'redirect'),
    ...
    group('Document API', () {
      ...
      test('should get single document', () async {
        when(mockApiClient.get<Map<String, dynamic>>('/api/documents/doc1'))
            .thenAnswer((_) async => {
          'id': 'doc1',
          'library_id': 'lib1',
          'title': 'Document 1',
        ...
        verify(mockApiClient.get<Map<String, dynamic>>('/api/documents/doc1')).called(1);
      });
    ...
    group('Error Handling', () {
      ...
      test('should handle unauthorized responses', () async {
        when(mockApiClient.get<Map<String, dynamic>>('/api/documents'))
            .thenThrow(DioException(
