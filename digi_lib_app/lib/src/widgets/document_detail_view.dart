...
class DocumentDetailView extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (document.metadataJson != null &&
                document.metadataJson!.isNotEmpty) ...[
              const SizedBox(height: 16),
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                spacing: 8,
                runSpacing: 8,
                children: [_buildStatusChip(context), _buildTypeChip(context)],
              ),
            ],
          ),
        ),
  ...
  Widget _buildBasicInfoSection(BuildContext context) {
    return _buildSection(
      ...
      children: [
        if (document.title != null) _buildInfoRow('Title', document.title!),
        if (document.author != null) _buildInfoRow('Author', document.author!),
  ...
  Widget _buildPlaceholderIcon(BuildContext context) {
    ...
    return Center(child: Icon(iconData, size: 64, color: iconColor));
  }
  ...
  Widget _buildTypeChip(BuildContext context) {
    ...
    return Chip(
      label: Text(extension, style: const TextStyle(fontSize: 12)),
