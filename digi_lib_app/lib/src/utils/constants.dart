...
class ErrorMessages {
  ...
  static const String syncError = 'Synchronization failed. Changes will be synced when connection is restored.';
  static const String storageError = 'Storage error. Please check available disk space.';
