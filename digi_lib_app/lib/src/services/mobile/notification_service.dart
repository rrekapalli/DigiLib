...
class MobileNotificationService {
  ...
  static Future<void> initialize() async {
    ...
    try {
      ...
      _isInitialized = true;
      AppLogger.info('Mobile notification service initialized');
    } catch (e) {
  ...
  static void _handleNotificationNavigation(String payload) {
    ...
    AppLogger.info('Navigating based on notification payload: $payload');
  }
  ...
  static Future<void> showSyncCompletionNotification({
    ...
    try {
      ...
      AppLogger.error('Error showing sync notification', e);
    }
  }
  ...
  static Future<void> showDownloadProgressNotification({
    ...
    try {
      ...
      AppLogger.error('Error showing download notification', e);
    }
  }
  ...
  static Future<void> showErrorNotification({
    ...
    try {
      ...
      AppLogger.error('Error showing error notification', e);
    }
  }
  ...
  static Future<void> showReadingReminderNotification({
    ...
    try {
      ...
      AppLogger.error('Error showing reading reminder', e);
    }
  }
  ...
  static Future<void> cancelNotification(int id) async {
    ...
    try {
      ...
      AppLogger.error('Error canceling notification', e);
    }
  }
  ...
  static Future<void> cancelAllNotifications() async {
    ...
    try {
      ...
      AppLogger.error('Error canceling all notifications', e);
    }
  }
  ...
  static Future<void> dispose() async {
    ...
    try {
      ...
      AppLogger.info('Mobile notification service disposed');
    } catch (e) {
      AppLogger.error('Error disposing notification service', e);
    }
  }
